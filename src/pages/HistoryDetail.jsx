...
export default function HistoryDetail() {
  ...
  return (
    <div className="flex flex-col h-screen" style={{ background: 'linear-gradient(180deg, #050D1A 0%, #030A14 100%)' }}>
      ...
      {/* Header */}
      <div className="relative flex items-center justify-between px-5 pt-safe-or-5 pb-3 flex-shrink-0">
        <button
        ...
        <button
          ...
          className="flex items-center justify-center w-8 h-8 rounded-xl transition-colors hover:bg-red-500/10"
      ...
      <div className="relative flex-1 overflow-y-auto min-h-0">
        <div className="px-5 pb-10">
          ...
          <div
            ...
            style={{ background: 'rgba(255,255,255,0.04)', border: '1px solid rgba(255,255,255,0.06)' }}
          >
            <p className="text-cream/30 text-[11px] font-semibold uppercase tracking-[0.1em] mb-2.5">Summary</p>
          ...
          {/* Transcript */}
          <p className="text-cream/30 text-[11px] font-semibold uppercase tracking-[0.1em] mb-3">Transcript</p>
          {validTurns.length === 0 ? (
